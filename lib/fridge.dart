                ...
                child: FloatingActionButton(
                    ...
                    onPressed: () async {
                      ...
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => ProductPreviewFridge(_barcode),
                          ));
                    },
                  ...
                  if (snapshot.hasData) {
                    return AlertDialog(
                      ...
                      content: Column(
                        ...
                        children: [
                          Text(
                              'Kalorien: ${snapshot.data!
                                  .first['kalorien']} kcal'),
                          Text('Fett: ${snapshot.data!.first['fett']} g'),
                          Text(
                              'davon gesättigte Fettsäuren: ${snapshot.data!
                                  .first['gesaettigt']} g'),
                          Text(
                              'Kohlenhydrate: ${snapshot.data!
                                  .first['kohlenhydrate']} g'),
                          Text(
                              'davon Zucker: ${snapshot.data!
                                  .first['davonZucker']} g'),
